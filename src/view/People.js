...
export default class People extends Component {
  ...
  openModal = (user) =>  this.setState({ isOpen: true, user: user, image: user.image, clickedID: user._id, newemail: user.email, newfirstname: user.firstName, newlastname: user.lastName, newposition: user.position });
    ...
    if(this.state.loading)return <Spinner animation={'LoadingCircle'}></Spinner>
      ...
      <SafeAreaView style={styles.all}>
        ...
        <RNModal 
          ...
          animationType={'slide'}
        >
          <View style ={styles.modal} id="MODAL">
            <View style={styles.modalHeader} id="HEADER">
            <ModalMenu pic={this._pickImage} openCal={this.openCalendar} showDate={this.showDateTimePicker} edit={this.onEditClick}></ModalMenu>
            <Text style={{ paddingBottom: 10 , fontSize:34}}>
